...
from config import DESKTOP_VERSION, DESKTOP_FILE, DESKTOP_DIR, DESKTOP_URL
...
def desktop_update():
    ...
    size = os.path.getsize(DESKTOP_FILE) if exists else 0
    return {
        "available": exists,
        "version": DESKTOP_VERSION,
        "exe_size": size,
        "exe_url": DESKTOP_URL if exists else None,
    }


app.mount("/desktop", StaticFiles(directory=DESKTOP_DIR, check_dir=False), name="desktop")

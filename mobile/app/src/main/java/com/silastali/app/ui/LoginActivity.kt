...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnModuleTrubo.setOnClickListener { openBlockOrders(Stages.TRUBO) }
        ...
        val metalLabels = listOf(
            ...
            binding.tvBlockMech, binding.tvBlockWeld, binding.tvBlockStore, binding.tvBlockTrubo,
        )
    ...
    private fun openBlockOrders(block: String) {
        val intent = Intent(this, BlockOrdersActivity::class.java)
